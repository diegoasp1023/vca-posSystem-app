  ...
  es: {
    translation: {
      ...
      admin: {
        ...
        costAmountHint: 'El monto se formatea automáticamente como "$X COP por persona".',
        costIncludesNote:
          'Se incluye automáticamente: "Ambas incluyen materiales y certificado de asistencia".',
        paymentIncludesNote:
  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        costAmountHint: 'The amount is automatically formatted as "$X COP per person".',
        costIncludesNote:
          'Automatically included: "Both include materials and a completion certificate".',
