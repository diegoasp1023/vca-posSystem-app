...
def test_sweep_orphaned_course_images_removes_unreferenced_files(upload_dir):
    ...
    removed = sweep_orphaned_course_images({"/uploads/courses/used.jpg"})
...
def test_sweep_orphaned_course_images_handles_missing_dir(upload_dir):
    removed = sweep_orphaned_course_images(set())
